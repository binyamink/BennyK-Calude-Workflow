---
name: review-julia
description: Run the Julia code review protocol on Julia scripts. Checks code quality, type stability, reproducibility, domain correctness, and professional standards. Produces a report without editing files.
...
1. **Identify scripts to review:**
   ...
   - If `$ARGUMENTS` is `all`: review all Julia scripts in `scripts/julia/`
